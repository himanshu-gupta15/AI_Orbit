...
import { Orbit, ArrowRight, Lock, Mail, User, AlertCircle, Loader2 } from "lucide-react";
      ...
      <div className="relative w-full max-w-md rounded-2xl border border-[#232326] bg-[#131316]/90 p-8 shadow-2xl backdrop-blur-xl">
        <div className="flex flex-col items-center text-center mb-8">
          ...
          <p className="text-xs text-[#a1a1aa] mt-1.5">
            Join AI Orbit to bookmark tools, submit apps, and receive curated updates
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <div className="relative">
              <User className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-[#71717a]" />
              <input
                type="text"
                required
                value={name}
          ...
          <div>
            ...
            <p className="text-[10px] text-[#71717a] mt-1">Must contain at least 8 characters</p>
          </div>
        ...
        <div className="mt-6 text-center text-xs text-[#71717a]">
          ...
          <Link
            href={`/login${redirect !== "/tools" ? `?redirect=${encodeURIComponent(redirect)}` : ""}`}
